...
@interface IPADecryptCKSigningSession : NSObject
...
int ipadecrypt_mescal_sign(
    ...
    *outputLength = 0;
    ...
    @autoreleasepool {
        ...
        IPADecryptCKSigningSession *session = [(id)[signingSessionClass alloc] initWithStoreClient:nil];
        if (session == nil) {
